...
func (_u *SettingUpdate) SetSettingsKey(v string) *SettingUpdate {
	_u.mutation.SetSettingsKey(v)
	return _u
}

// SetNillableSettingsKey sets the "settings_key" field if the given value is not nil.
func (_u *SettingUpdate) SetNillableSettingsKey(v *string) *SettingUpdate {
	if v != nil {
		_u.SetSettingsKey(*v)
	}
	return _u
...
func (_u *SettingUpdate) SetSettingContent(v string) *SettingUpdate {
	_u.mutation.SetSettingContent(v)
	return _u
}

// SetNillableSettingContent sets the "setting_content" field if the given value is not nil.
func (_u *SettingUpdate) SetNillableSettingContent(v *string) *SettingUpdate {
	if v != nil {
		_u.SetSettingContent(*v)
	}
	return _u
}
...
func (_u *SettingUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SettingsKey(); ok {
		_spec.SetField(setting.FieldSettingsKey, field.TypeString, value)
	}
	if value, ok := _u.mutation.SettingContent(); ok {
		_spec.SetField(setting.FieldSettingContent, field.TypeString, value)
	}
...
// SetSettingsKey sets the "settings_key" field.
func (_u *SettingUpdateOne) SetSettingsKey(v string) *SettingUpdateOne {
	_u.mutation.SetSettingsKey(v)
	return _u
}

// SetNillableSettingsKey sets the "settings_key" field if the given value is not nil.
func (_u *SettingUpdateOne) SetNillableSettingsKey(v *string) *SettingUpdateOne {
	if v != nil {
		_u.SetSettingsKey(*v)
	}
	return _u
...
// SetSettingContent sets the "setting_content" field.
func (_u *SettingUpdateOne) SetSettingContent(v string) *SettingUpdateOne {
	_u.mutation.SetSettingContent(v)
	return _u
}

// SetNillableSettingContent sets the "setting_content" field if the given value is not nil.
func (_u *SettingUpdateOne) SetNillableSettingContent(v *string) *SettingUpdateOne {
	if v != nil {
		_u.SetSettingContent(*v)
	}
	return _u
