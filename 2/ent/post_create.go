...
func (_c *PostCreate) SetPostTitle(v string) *PostCreate {
	_c.mutation.SetPostTitle(v)
	return _c
}

// SetPostContent sets the "post_content" field.
func (_c *PostCreate) SetPostContent(v string) *PostCreate {
	_c.mutation.SetPostContent(v)
	return _c
}

// SetNillablePostContent sets the "post_content" field if the given value is not nil.
func (_c *PostCreate) SetNillablePostContent(v *string) *PostCreate {
	if v != nil {
		_c.SetPostContent(*v)
	}
	return _c
...
func (_c *PostCreate) check() error {
	if _, ok := _c.mutation.PostTitle(); !ok {
		return &ValidationError{Name: "post_title", err: errors.New(`ent: missing required field "Post.post_title"`)}
	}
	if v, ok := _c.mutation.PostTitle(); ok {
