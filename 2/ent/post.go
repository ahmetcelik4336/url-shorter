...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case post.FieldPostTitle, post.FieldPostContent:
...
func (_m *Post) String() string {
	...
	builder.WriteString(_m.PostTitle)
	builder.WriteString(", ")
	builder.WriteString("post_content=")
	builder.WriteString(_m.PostContent)
	builder.WriteByte(')')
