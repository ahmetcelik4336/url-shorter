...
func (_c *SettingCreate) SetSettingsKey(v string) *SettingCreate {
	_c.mutation.SetSettingsKey(v)
	return _c
}

// SetSettingContent sets the "setting_content" field.
func (_c *SettingCreate) SetSettingContent(v string) *SettingCreate {
	_c.mutation.SetSettingContent(v)
	return _c
}
...
func (_c *SettingCreate) check() error {
	if _, ok := _c.mutation.SettingsKey(); !ok {
		return &ValidationError{Name: "settings_key", err: errors.New(`ent: missing required field "Setting.settings_key"`)}
	}
	if _, ok := _c.mutation.SettingContent(); !ok {
		return &ValidationError{Name: "setting_content", err: errors.New(`ent: missing required field "Setting.setting_content"`)}
	}
	return nil
}
...
func (_c *SettingCreate) createSpec() (*Setting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SettingContent(); ok {
		_spec.SetField(setting.FieldSettingContent, field.TypeString, value)
		_node.SettingContent = value
	}
	return _node, _spec
}
